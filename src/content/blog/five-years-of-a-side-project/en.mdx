...
- **2021 · Eumseong plant**: Spring Boot + Thymeleaf, MariaDB. Inbound/outbound and inventory management, integration with the client's system
- **2025 · Seosan plant**: NestJS + React, PostgreSQL. Mobile barcode scanning for inbound/outbound, inventory and stats dashboards, automatic data collection from client systems, automatic delivery slip issuing
- **Server**: One PC. Started with a Ryzen 7 5700G / 32GB, now a Ryzen 7 7700 / 64GB
- **How it runs**: Started with sh scripts, moved to docker compose, now k3s
